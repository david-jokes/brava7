...
let zatim = document.querySelector(".navigace-mobil")

nav.addEventListener("click", function(){
  nav.classList.toggle("burger-rotate")
  zatim.classList.toggle("navigace-mobil-show")
})

const close = document.querySelector("#close")

close.addEventListener("click", function(){
  close.classList.toggle("close-animate")
  zatim.classList.toggle("navigace-mobil-show")
})

// Animace textů na scroll
const jedna = document.querySelector("#jedna")
const dva = document.querySelector("#dva")
const tri = document.querySelector("#tri")
const ctyri = document.querySelector("#ctyri")

window.addEventListener("scroll", function(){
  jedna.style.transform = `translateX(-${scrollY/4.5}px)`
  dva.style.transform = `translateX(${scrollY/4.5}px)`
  tri.style.transform = `translateX(${scrollY/10}px)`
  ctyri.style.transform = `translateX(${-scrollY/10}px)`
})
