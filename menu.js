...
const obrazky = document.querySelectorAll(".item")

obrazky.forEach(function(cokoliv){
  cokoliv.addEventListener("mouseenter", function(e){
    e.currentTarget.children[0].children[0].style.scale = "1.4"
  })
  cokoliv.addEventListener("mouseleave", function(e){
